...
<main class="c-main">
    <div class="c-body">
        <div class="container" style = "border-radius: 35px;margin: 40px;">
            <form action="{{ url('schedules/update/'.$key) }}" enctype="multipart/form-data" method="POST" style="text-align:left;">
                <div class="row">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="date" name="date" type="date" value="{{$editData['date']}}">
                                </div>
